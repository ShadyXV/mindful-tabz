...
import './index.css'
import { storageEngine, type ScreenTimeEntry } from './lib/StorageEngine'
...
const Blocked = () => {
  ...
  React.useEffect(() => {
    ...
    storageEngine.getFullState().then(data => {
      // Sort stats by time spent descending
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white p-4 font-sans">
      <div className="max-w-md w-full text-center space-y-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl space-y-4">
          <h2 className="text-sm font-bold uppercase tracking-widest text-slate-400 text-left">Today's Screen Time</h2>
